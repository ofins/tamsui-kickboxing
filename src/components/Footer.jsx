    ...
    <div className="footer--container">
      <div className="sec-A">
        ...
        <div className="social-icons">
          <a
            rel="noreferrer"
            href="https://liff.line.me/1645278921-kWRPP32q/?accountId=qnl8292y"
            target="_blank"
          >
          ...
          <a
            rel="noreferrer"
            href="https://www.facebook.com/TamsuiKB"
            target="_blank"
          >
            <LazyLoadImage src="./svg/fb.png" alt="facebook-icon" />
          </a>
          <a
            rel="noreferrer"
            href="https://www.instagram.com/tamsui_kickboxing/"
            target="_blank"
          >
            <LazyLoadImage src="./svg/insta.png" alt="square-instagram-icon" />
          </a>
        </div>
      </div>
      <div className="sec-B">
        ...
        <p>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            href="https://www.instagram.com/jackwang.studio"
          >
            jackwang.Studio 
          </a>
